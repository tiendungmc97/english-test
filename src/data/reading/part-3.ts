    ...
    questions: [
      {
        id: 1,
        question:
          "I have a dream of working as a tour guide. So I understand that I will have to fly to other countries. In my personal opinion, airplanes are currently too cheap compared to the damage they cause to the environment. So sometimes I choose other means of transport before they think about flying. I believe that people are also very happy when they can contribute to volunteering to clean up in the neighborhood.",
        order: "A",
      },
      {
        id: 2,
        question:
          "My family and siblings live quite far from me. So I often have to fly to visit them every month. I don't have other jobs when I appreciate. We can enjoy together, and we are happy to be able to be with each other and share our own stories. I know that people here are much more interested in the environment, so I often shop online or to work by bike instead of going by car or reusing plastic bags and paper bags. In addition, I sometimes volunteer to clean up trash in the neighborhood.",
        order: "B",
      },
      {
        id: 3,
        question:
          "I'm a businessman so I have to fly many times a week. I have to go to other countries to be able to do wine trading contracts with them. I don't like flying. Neither my wife and I, whenever we have free time, take the train together, and we enjoy the train very much because I can travel while sightseeing and relax without any stress.",
        order: "C",
      },
      {
        id: 4,
        question:
          "If I have to go somewhere, I will choose other means of public transport, not planes. Every time I go on a plane, I feel extremely tired, and I just hope that planes quickly so I can get off that plane and relax. I go to the specific places of my trip to do so in many different locations, so sometimes I cannot avoid having to take public transportation.",
        order: "D",
      },
    ],
    listAnswers: [
      {
        title: "Who suggests making flights more expensive?",
        match: "A",
      },
      {
        title: "Who wants to work in other countries?",
        match: "A",
      },
      {
        title: "Who visits relative regularly?",
        match: "B",
      },
      {
        title: "Who tries to protect the environment?",
        match: "B",
      },
      {
        title: "Who likes relaxing while they travel?",
        match: "C",
      },
      {
        title: "Who needs to fly for their work?",
        match: "C",
      },
      {
        title: "Who finds flying tiring?",
        match: "D",
      },
    ],
  },
    ...
    questions: [
      {
        id: 1,
        question:
          "When I first came to this city, I felt very scared because this city is very big. The city has many parts, and the shopping part is very far from the green part. However, we already had the bus route, and we signed up to take the bus for a full day. Buses are very cheap and very convenient. I feel very lucky not to have to put pressure on my sore feet.",
        order: "A",
      },
      {
        id: 2,
      ...
      },
      {
        id: 3,
        question:
          "I visit this city last summer and really liked the atmosphere of this city. The reason I like the atmosphere here is because it has a lot of public performances. These performances often take place in front of department stores, so this presents me from shopping inside those stores. I was very surprised when I came home with an empty bag, and I didn't buy anything.",
        order: "C",
      },
      {
        id: 4,
        question:
          "When I go out, I only care about two things: good food and good play. I especially liked the lunch I had in this city, it was delicious, and I really want to come back here next time. However, I guess I had to wait to get there. However, it didn't matter because I had a wonderful day.",
        order: "D",
      },
    ],
    listAnswers: [
      {
        title: "Who thinks the public transport system was good?",
        match: "A",
      },
      {
        title: "Who thinks walking too much causes a problem?",
        match: "A",
      },
      {
        title: "Who likes the natural resort here?",
        match: "B",
      },
      {
        title: "Who visits one part of the city?",
        match: "B",
      },
      {
        title: "Who likes the public theater that the city puts on?",
        match: "C",
      },
      {
        title: "Who usually spends a lot of money on shopping?",
        match: "C",
      },
      {
        title: "Who pays a lot for their meal?",
        match: "D",
      },
    ],
  },
